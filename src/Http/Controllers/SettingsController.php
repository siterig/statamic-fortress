...
use Siterig\Fortress\Security\Settings;
...
class SettingsController extends Controller
{
    public function index()
    {
        ...
        return view('fortress::settings', compact('settings', 'countries'));
    }
    ...
    {
        $command = new UpdateGeoIPDatabase();
        $command->handle();

        return back()->with('success', 'GeoIP database updated successfully.');
    }
